...
export declare class FriendService {
     ...
     * 发送好友请求
     */
    sendFriendRequest(userId: string, friendId: string, message?: string): Promise<Friendship>;
    /**
     * 接受好友请求
     */
     ...
     * 搜索用户(按昵称或手机号)
     */
    searchUsers(keyword: string, currentUserId: string): Promise<User[]>;
    /**
     * 推荐可能感兴趣的人
     */
     ...
     * 检查好友关系状态
     */
    getFriendshipStatus(userId: string, friendId: string): Promise<string | null>;
}

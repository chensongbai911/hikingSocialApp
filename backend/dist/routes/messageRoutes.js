...
// 撤回消息
router.post('/:messageId/recall', authMiddleware, MessageController.recallMessage);
// 举报消息
router.post('/:messageId/report', authMiddleware, MessageController.reportMessage);
// 黑名单管理

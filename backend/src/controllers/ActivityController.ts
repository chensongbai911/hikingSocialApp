...
export class ActivityController {
  ...
  static async updateActivity(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (photos !== undefined) updateData.photos = photos; // 照片数组
      ...
      if (route_description !== undefined) updateData.route_description = route_description;
      if (equipment_required !== undefined) updateData.equipment_required = equipment_required;
   ...
   */
  static async joinActivity(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const userId = req.user?.id;
   ...
   */
  static async leaveActivity(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const userId = req.user?.id;
   ...
   */
  static async getUserJoinedActivities(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async getMyJoinedActivities(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user?.id;
   ...
   */
  static async getMyCreatedActivities(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user?.id;
